...
export async function GET() {
  ...
  return Response.json({
    accountAssociation: {
      header:
        "eyJmaWQiOjYzNzEzOSwidHlwZSI6ImN1c3RvZHkiLCJrZXkiOiIweEM2NDY1NDdjOTFBQTU4YTEyZDkwNjVFRDIwZDI3NmJmRTg4MTYzNjMifQ",
    ...
    frame: withValidProperties({
      ...
      screenshotUrls: [],
      iconUrl: "https://ferianounish2025.vercel.app/images/feria-icon-512.jpg",
      splashImageUrl: "https://ferianounish2025.vercel.app/images/feria-splash-200.jpg",
