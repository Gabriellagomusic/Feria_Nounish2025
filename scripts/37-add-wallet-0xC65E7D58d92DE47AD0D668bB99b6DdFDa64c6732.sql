-- Add wallet 0xC65E7D58d92DE47AD0D668bB99b6DdFDa64c6732 to FeriaNounish-Artistas whitelist
...
SELECT 
    CASE 
        WHEN EXISTS (
            ...
            WHERE LOWER(id) = LOWER('0xC65E7D58d92DE47AD0D668bB99b6DdFDa64c6732')
        ) 
...
VALUES (LOWER('0xC65E7D58d92DE47AD0D668bB99b6DdFDa64c6732'))
