-- Script to add wallet 0xf40453f9c8A342e2CCc88E961F464Ce84996f7Ac to the FeriaNounish artist whitelist
-- This script will:
...
SELECT 
    CASE 
        WHEN EXISTS (
            ...
            WHERE LOWER(id) = LOWER('0xf40453f9c8A342e2CCc88E961F464Ce84996f7Ac')
        ) 
...
VALUES (LOWER('0xf40453f9c8A342e2CCc88E961F464Ce84996f7Ac'))
