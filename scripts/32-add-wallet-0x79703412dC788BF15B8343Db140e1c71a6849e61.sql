-- Add wallet 0x79703412dC788BF15B8343Db140e1c71a6849e61 to FeriaNounish-Artistas whitelist
...
SELECT 
    CASE 
        WHEN EXISTS (
            ...
            WHERE LOWER(id) = LOWER('0x79703412dC788BF15B8343Db140e1c71a6849e61')
        ) 
...
VALUES (LOWER('0x79703412dC788BF15B8343Db140e1c71a6849e61'))
...
SELECT 
    CASE 
        ...
        THEN '✓ Wallet 0x79703412dC788BF15B8343Db140e1c71a6849e61 is whitelisted'
